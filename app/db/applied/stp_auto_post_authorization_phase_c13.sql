-- Phase C13: Correct service-role STP authorization and align C11 constraints.
...
ALTER TABLE public.suppliers
  ...
  CHECK (
    stp_max_amount IS NULL
    OR (stp_max_amount <> 'NaN'::NUMERIC AND stp_max_amount >= 0)
  );
...
SELECT 'stp_auto_post_authorization_phase_c13_applied' AS migration_note;
